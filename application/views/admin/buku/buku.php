	<div class="col-12">
		<div class="card">
			...
			: 'https://via.placeholder.com/60x80.png?text=No+Cover' ?>" class="img-thumbnail" style="width:120px; height:80px;">
								</td>
...
<div class="modal fade" id="addBabModal<?= $b->id ?>" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <!-- Tombol Edit -->
                  <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#editBab<?= $bab->id_bab ?>">
                    <i class="bi bi-pencil-square"></i>
                  </button>
                  <!-- Tombol Delete -->
                  <button class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteBab<?= $bab->id_bab ?>">
                    <i class="bi bi-trash"></i>
                  </button>
                </td>
              </tr>
                    ...
                    <form action="<?= site_url('admin/bab/update') ?>" method="post">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" name="judul_bab" value="<?= $bab->judul_bab ?>" class="form-control" required>
                        </div>
                        <div class="mb-3">
                          <label class="form-label">Urutan</label>
                          <input type="text" name="urutan" value="<?= $bab->urutan ?>" class="form-control" required>
                        </div>
                        <div class="mb-3">
                          <label class="form-label">Isi Bab</label>
                          <textarea name="isi" class="form-control" rows="3" required><?= $bab->isi ?></textarea>
                        </div>
                      </div>
                      <div class="modal-footer">
              ...
              <!-- Modal Delete Bab -->
              <div class="modal fade" id="deleteBab<?= $bab->id_bab ?>" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
	...
	<!-- Modal Tambah Bab -->
<!-- Modal Tambah Bab -->
<div class="modal fade" id="tambahBab<?= $b->id ?>" tabindex="-1" aria-labelledby="tambahBabLabel<?= $b->id ?>" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <form action="<?= site_url('admin/bab/store') ?>" method="post">
        <div class="modal-header">
          <h5 class="modal-title" id="tambahBabLabel<?= $b->id ?>">Tambah Bab untuk Buku: <?= $b->judul ?></h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
        </div>
        <div class="modal-body">
          <input type="hidden" name="id_buku" value="<?= $b->id ?>">
          ...
          <div class="mb-3">
            <label for="urutan<?= $b->id ?>" class="form-label">Urutan</label>
            <input type="number" class="form-control" id="urutan<?= $b->id ?>" name="urutan" placeholder="Contoh: 1" required>
          </div>
