...
<body class="flex relative overflow-x-hidden min-h-screen">
    ...
    <div class="flex-1 flex flex-col min-h-screen">
        ...
        <main class="flex-1 p-8">
            <h1 class="text-2xl font-bold text-gray-800 mb-4">👨‍🏫 Manajemen User | ByeFest</h1>
                ...
                <table class="w-full text-left text-gray-500">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            <td class="py-3 px-6"><?= $u->nama ?></td>
                            <td class="py-3 px-6"><?= $u->email ?></td>
                            <td class="py-3 px-6"><?= $u->level ?></td>
            ...
            <div id="tambahGuruModal"
                ...
                <div
                    class="modal-content relative top-20 mx-auto p-5 border w-11/12 md:w-1/2 lg:w-1/3 shadow-lg rounded-md bg-white">
                    <div class="mt-3">
                        <div class="flex justify-between items-center pb-3 border-b">
                            <h3 class="text-xl font-semibold text-gray-800">Tambah Data User</h3>
                            <button onclick="closeModal()" class="text-gray-400 hover:text-gray-600">
                                <i class="bi bi-x-circle text-2xl"></i>
                            </button>
                        </div>

                        <form action="<?= base_url('admin/user/simpan') ?>" method="POST" class="space-y-4 mt-4">
                            <div>
            ...
            <div id="editUserModal"
                ...
                <div
                    ...
                    <div class="mt-3">
                        <div class="flex justify-between items-center pb-3 border-b">
                            <h3 class="text-xl font-semibold text-gray-800">Edit Data User</h3>
                            <button onclick="closeEditModal()" class="text-gray-400 hover:text-gray-600">
                                <i class="bi bi-x-circle text-2xl"></i>
                            </button>
                        </div>

                        <form id="editUserForm" action="" method="POST" class="space-y-4 mt-4">
                            <input type="hidden" id="edit_id_user" name="id_user">
                            
                            <div>
                                <label for="edit_nama" class="block text-sm font-medium text-gray-700 mb-1">Nama User</label>
                            ...
                            <div>
                                <label for="edit_level" class="block text-sm font-medium text-gray-700 mb-1">Level</label>
            ...
            <script>
                ...
                function openEditModal(id_user, nama, email, level) {
                    ...
                    // Set action form
                    document.getElementById('editUserForm').action = '<?= base_url('admin/user/update/') ?>' + id_user;
                ...
                window.onclick = function (event) {
                    const modalTambah = document.getElementById('tambahGuruModal');
