					...
					<tbody>
						...
						<tr class="border-b hover:bg-gray-50">
							...
							<td class="py-3 px-6 text-center space-x-2">
								<a href="<?= site_url('admin/user/edit/'.$u->id_user) ?>"
				...
				<div
					...
					<div class="mt-3">
						...
						<form action="<?= base_url('admin/user/simpan') ?>" method="POST" class="space-y-4 mt-4">
							...
							<div>
								<label for="nip" class="block text-sm font-medium text-gray-700 mb-1">Email</label>
								<input type="text" id="email" name="email" required
									class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
							</div>

							<div>
								<label for="mapel" class="block text-sm font-medium text-gray-700 mb-1">Password</label>
								<input type="text" id="password" name="password" required
									class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
							</div>

							<label for="mapel" class="block text-sm font-medium text-gray-700">Level</label>
							<div class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
