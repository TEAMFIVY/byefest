<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h4><i class="bi bi-list-task me-2"></i> Detail Tryout: <?= $tryout->judul ?></h4>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="mb-4 p-3 border rounded bg-light">
            ...
            <div class="row g-2">
                ...
                <div class="col-md-4">
                    <input type="number" id="jumlahOpsi" class="form-control" placeholder="Jumlah Opsi per Soal" min="2" max="10">
                </div>
                <div class="col-md-4">
                    <button class="btn btn-primary w-100" id="buatFormSoal">
                        <i class="bi bi-plus-circle"></i> Buat Form Soal
                    </button>
                </div>
            </div>
        </div>

        <form method="post" action="<?= site_url('admin/tryout/simpan_massal') ?>" id="formSoalMassal">
            ...
            <div class="mt-3">
                ...
                <a href="<?= base_url('admin/tryout') ?>" class="btn btn-secondary">Kembali</a>
            </div>
        </form>

        <hr>
        <h5>Daftar Soal Tryout</h5>
        ...
        <?php if (!empty($soal)): ?>
            ...
            <div class="mb-4 p-3 border rounded shadow-sm">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal"
                            data-bs-target="#editSoal<?= $s->id_soal ?>"><i class="bi bi-pencil"></i></button>
                        <a href="<?= site_url('admin/tryout/delete_soal/'.$s->id_soal.'/'.$tryout->id_tryout) ?>"
                ...
                <ul class="mt-2">
                    <?php 
                    $opsi = $this->db->get_where('opsi_tryout',['id_soal'=>$s->id_soal])->result();
                    if (!empty($opsi)): 
                        foreach($opsi as $o): ?>
            ...
            <div class="modal fade" id="editSoal<?= $s->id_soal ?>" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <form method="post" action="<?= site_url('admin/tryout/update_soal') ?>">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <textarea name="pertanyaan" class="form-control" required><?= htmlspecialchars($s->pertanyaan) ?></textarea>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <div class="input-group-text">
                                            <input type="radio" name="jawaban_benar" value="<?= $i ?>" <?= $o->jawaban_benar ? 'checked' : '' ?>> Benar
                                        </div>
                                    </div>
                                    <?php endforeach; ?>
                                </div>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p><em>Belum ada soal untuk tryout ini.</em></p>
        <?php endif; ?>
    </div>
</div>
