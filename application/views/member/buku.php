  ...
  <body>
    <header>
      <div class="header-container">
        <a href="<?= base_url('assets/buku.css') ?>../member/member.html" style="text-decoration: none;">
              ...
              <div class="user-section">
                  ...
                  <div class="profile-dropdown" id="profileDropdown">
                      ...
                      <div class="dropdown-menu">
                          <a class="dropdown-item" href="<?= base_url('assets/buku.css') ?>../profile/profile.html"
                          ...
                          <a class="dropdown-item" href="<?= base_url('assets/buku.css') ?>../forum_diskusi/forum_diskusi.html">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                  <path stroke="currentColor" d="M5 6h14M5 12h10M5 18h7" />
                              </svg>
                              Forum Diskusi
                          </a>
                          <a class="dropdown-item" href="<?= base_url('assets/buku.css') ?>../login/login.html">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    ...
    <section class="hero">
      <div class="hero-container">
        <div class="hero-image">
          <img src="<?= base_url('assets/buku.css') ?>../ban.png" alt="Siswa Belajar">
      ...
      <div class="book-grid">
        <div class="book-card">
          ...
          <div class="book-content">
            ...
            <button onclick="window.location.href='<?= base_url('assets/buku.css') ?>../detail_buku/detail_bukumtk.html'">Lihat Detail</button>
          </div>
        </div>
        ...
        <div class="book-card">
          ...
          <div class="book-content">
            ...
            <button onclick="window.location.href='<?= base_url('assets/buku.css') ?>../detail_buku/detail_buku.htmlmtk'">Lihat Detail</button>
          </div>
        </div>
      ...
      <div class="book-grid">
        <div class="book-card">
          ...
          <div class="book-content">
            ...
            <button onclick="window.location.href='<?= base_url('assets/buku.css') ?>../detail_buku/detail_bukubing.html'">Lihat Detail</button>
          </div>
        </div>
      ...
      <div class="book-grid">
        <div class="book-card">
          ...
          <div class="book-content">
            ...
            <button onclick="window.location.href='<?= base_url('assets/buku.css') ?>../detail_buku/detail_bukuips.html'">Lihat Detail</button>
          </div>
        </div>
        ...
        <div class="book-card">
          ...
          <div class="book-content">
            ...
            <button onclick="window.location.href='<?= base_url('assets/buku.css') ?>../detail_buku/detail_bukusos.html'">Lihat Detail</button>
          </div>
        </div>
        ...
        <div class="book-card">
          ...
          <div class="book-content">
            ...
            <button onclick="window.location.href='<?= base_url('assets/buku.css') ?>../detail_buku/detail_bukugeo.html'">Lihat Detail</button>
          </div>
        </div>
        ...
        <div class="book-card">
          ...
          <div class="book-content">
            ...
            <button onclick="window.location.href='<?= base_url('assets/buku.css') ?>../detail_buku/detail_bukueko.html'">Lihat Detail</button>
          </div>
        </div>
